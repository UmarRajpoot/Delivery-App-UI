...
const Home = ({navigation}) => {
  ...
  const [resturent, setResturent] = useState(restaurantData);
  ...
  function onSelectedCategory(category) {
    // lets Filter the Data according to the Category
    let resturentList = restaurantData.filter((a) =>
      a.categories.includes(category.id),
    );
    setResturent(resturentList);
  ...
  ///////////////////////////////////////////////
  function renderResturentList() {
    // Render the Items of Resturent
